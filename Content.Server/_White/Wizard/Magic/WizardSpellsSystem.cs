...
public sealed class WizardSpellsSystem : EntitySystem
{
    ...
    // TODO: [WD] Uncomment after telefrag system port
    ...
    private void OnMindswapSpell(MindswapSpellEvent msg)
    {
        ...
        /* TODO: [WD] Uncomment after Borer and Cult port
        ...
        */
        ...
        // TODO: [WD] Uncomment after ghost teleport UI port
        ...
        */
        ...
        /* TODO: [WD] Uncomment after lying system port
    ...
    private void ForcewallSpellDefault(ForceWallSpellEvent msg)
    {
        ...
        foreach (var position in GetPositionsInFront(transform))
        {
    ...
    private void CardsSpellDefault(CardsSpellEvent msg)
    {
        ...
        for (var i = 0; i < 10; i++)
        {
            foreach (var pos in GetSpawnPositions(xform, msg.Pos))
            {
    ...
    private bool ArcSpellDefault(ArcSpellEvent msg)
    {
        ...
        {
            _lightning.ShootLightning(msg.Performer, entity, "WizardLightning");
        }
    ...
    {
        return new List<EntityCoordinates> { casterXform.Coordinates };
    }
